...
// CODE HERE 
const each = (array, callback) => array.forEach((item, index) => callback(item, index));
...
// CODE HERE 
const getUserById2 = (arr, id, callback) => {
...
// ternary
const getUserById = (arr, id, callback) => arr.forEach(elem => elem.id === id ? callback(elem) : null)
